...
- 本地第 4 轮论文和预注册为 `808bc8c`，实验实现与否证结论为 `90ff84f887404f87bb81c2a79526accf0e9e7fe4`；发布清单、部署闸门、脱敏和测试实现提交为 `ee2337a`。服务器仓库仍为已验收记录提交 `c08bda58bad856fa1bd24f8975385696dbad11bc`。第 2/3/4 轮与本次发布工具硬化都没有生产推理变化，因此不为同步离线实验或工具脚本而重启或替换服务。
